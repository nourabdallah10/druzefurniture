...
import { generateSofaProducts } from '../data/sofaProducts';
...
export const Sofas = () => {
  ...
  const allProducts = useMemo(() => generateSofaProducts(), []);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6 sm:mb-8" dir={language === 'he' ? 'rtl' : 'ltr'}>
        ...
        <p className="text-responsive-lg text-gray-600 dark:text-gray-300 px-2">{t('sofas.description')}</p>
      </div>
